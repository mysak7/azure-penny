...
async def root(request: Request):
    return _templates.TemplateResponse("dashboard.html", {"request": request, "version": _APP_VERSION})
...
async def technician(request: Request):
    return _templates.TemplateResponse("technician.html", {"request": request, "version": _APP_VERSION})


@router.get("/live", response_class=HTMLResponse)
async def live_view(request: Request):
    is_admin = "penny-admin" in _get_user_roles(request)
    return _templates.TemplateResponse("live.html", {"request": request, "is_admin": is_admin, "version": _APP_VERSION})


@router.get("/guide", response_class=HTMLResponse)
async def guide_view(request: Request):
    return _templates.TemplateResponse("guide.html", {"request": request, "version": _APP_VERSION})


@router.get("/shield", response_class=HTMLResponse)
async def shield_view(request: Request):
    return _templates.TemplateResponse("shield.html", {"request": request, "version": _APP_VERSION})
