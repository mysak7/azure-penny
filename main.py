...
@app.get("/shield", response_class=HTMLResponse, include_in_schema=False)
async def shield_view(request: Request):
    return templates.TemplateResponse("shield.html", {"request": request, "version": APP_VERSION})


# ── Shield API ────────────────────────────────────────────────────────────────

@app.get("/api/shield/status", tags=["api"])
...
@app.post("/api/shield/config", tags=["api"])
...
@app.post("/api/shield/test", tags=["api"])
